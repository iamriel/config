...
** Slack config
   #+BEGIN_SRC emacs-lisp :tangle ~/.user-config.el
     (slack-register-team
      :name "rocketmail"
      :default t
      :client-id "402953958275.773306931700"
      :client-secret "100bd115adf1855a7b200d78a5c4fe21"
      :token "xoxp-402953958275-404124583127-762314377555-80e558d7a4605f5ae121d6c28ccaafe9")
   #+END_SRC
